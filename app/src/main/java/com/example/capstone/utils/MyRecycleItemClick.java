...
/**
 * Created by cts on 24/1/19, 5:15 PM.
 */
public class MyRecycleItemClick implements RecyclerView.OnItemTouchListener {
    ...
    public MyRecycleItemClick(Context context, OnItemClickListener listener) {
